 ...
 * @author Admin
 */
public class UI_Server extends javax.swing.JFrame implements Runnable {
    ...
    public UI_Server() {
        initComponents();
        try {
            server = new ServerSocket(1023);
            socket = server.accept();
            Thread t = new Thread(UI_Server.this);
            t.start();
    ...
    private void Button_send_messageActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button_send_messageActionPerformed
        ...
        TextArea_show_message.append("Server: " + message + "\n");
    ...
    public void run() {
        try {
            ...
            while (true) {
                ...
                TextArea_show_message.append("Client: " + message_from_client + "\n");
                Thread.sleep(1000);
            }
        } catch (IOException ex) {
            Logger.getLogger(UI_Server.class.getName()).log(Level.SEVERE, null, ex);
